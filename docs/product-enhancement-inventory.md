...
## 一、WorkBuddy / CodeBuddy（35 项，主体最大）
...
| 远期/机会 | — | F-07、F-18、F-27、F-36、F-41、F-42、F-52、F-08 | — |
...
- v1 已完成三份源文档逐节核对（补记 6 条，见 v1 §3 / git 历史）；本次**仅重排不增删**，53 项数量守恒（35+7+4+7=53），无新增遗漏。
