...
/// 内含逐账号计费域网络请求（≤10s/账号）。
pub fn workbuddy_editions_backfill(state: &AppState) -> Result<usize, String> {
...
pub fn workbuddy_credits_history_list(state: &AppState) -> Result<serde_json::Value, String> {
