...
pub fn workbuddy_groups_list(state: &AppState) -> Vec<crate::commands::accounts::GroupView> {
...
pub fn workbuddy_groups_create(state: &AppState, name: String, color: String) -> Result<String, String> {
...
pub fn workbuddy_groups_remove(state: &AppState, id: String) -> Result<(), String> {
    let mut defs = load_defs(state);
